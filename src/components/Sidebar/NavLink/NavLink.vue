    ...
    <router-link :to="link" class="sidebar-link">
      <span class="icon">
        <i :class="fullIconName">
          ...
          <span class="h4"  v-if="iconName=='flaticon-shape'"><i class="mdi mdi-shape"></i></span>
          <span class="h4"  v-if="iconName=='flaticon-cog'"><i class="mdi mdi-cog"></i></span>
          <span class="h4"  v-if="iconName=='flaticon-alert'"><i class="mdi mdi-alert-decagram"></i></span>
          ...
          <span class="h4"  v-if="iconName =='flaticon-text-check'"><i class="mdi mdi-receipt-text-check"></i></span>
          <span class="h4"  v-if="iconName =='flaticon-history'"><i class="mdi mdi-history"></i></span>
